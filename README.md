# SOS Finança — V3.0.0 FINAL

Aplicativo financeiro **local e individual** para Windows e Android.

A V3 mantém a interface e a lógica financeira aprovadas na V2 e transforma o mesmo projeto em uma entrega preparada para os dois aparelhos: **PC + celular Android**, sem nuvem e sem compartilhamento de dados entre pessoas.
