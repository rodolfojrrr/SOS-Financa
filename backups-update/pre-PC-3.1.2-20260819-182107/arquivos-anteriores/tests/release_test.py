...
ok(main_conf['version'] == '3.1.2', 'configuração Tauri está na versão 3.1.2')
ok(re.search(r'^version = "3\.1\.2"$', cargo, re.M) is not None, 'pacote Rust está na versão 3.1.2')
...
ok("'on':\n  workflow_dispatch:" in android_yml and 'push:' not in android_yml.split('permissions:')[0], 'push comum não recompila Android automaticamente')
