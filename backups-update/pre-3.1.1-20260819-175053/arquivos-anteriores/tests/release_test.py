...
ok(main_conf['version'] == '3.1.0', 'configuração Tauri está na versão 3.1.0')
ok(re.search(r'^version = "3\.1\.0"$', cargo, re.M) is not None, 'pacote Rust está na versão 3.1.0')
